"""Communicate with a TDC001 motor controller that has an actuator attached."""
...
if TYPE_CHECKING:
    from msl.equipment.resources import KDC as TDC  # KDC is the newer model to TDC and has the same API
...
# Update 83860217 with the serial number of your motor controller.
connection = Connection(
    "FTDI2::0x0403::0xfaf0::83860217",
