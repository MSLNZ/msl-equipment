...
Benchtop_Piezo_FCNS = [
    ...
    ('PBC_GetMaxOutputVoltage', c_short, 'log_errcheck',
     [(c_char_p, 'serialNo'),
      (c_short, 'channel')]),
    ('PBC_RequestMaxOutputVoltage', c_bool, 'log_errcheck',
     [(c_char_p, 'serialNo'),
      (c_short, 'channel')]),
    ...
    ('PBC_GetOutputVoltage', c_short, 'log_errcheck',
     [(c_char_p, 'serialNo'),
      (c_short, 'channel')]),
    ('PBC_RequestOutputVoltage', c_bool, 'log_errcheck',
     [(c_char_p, 'serialNo'),
      (c_short, 'channel')]),
    ('PBC_SetOutputVoltage', c_short, 'errcheck_api',
     [(c_char_p, 'serialNo'),
      (c_short, 'channel'),
      (c_short, 'volts')]),
    ('PBC_RequestVoltageSource', c_bool, 'log_errcheck',
     [(c_char_p, 'serialNo'),
      (c_short, 'channel')]),
    ...
    ('PBC_SetVoltageSource', c_short, 'errcheck_api',
     [(c_char_p, 'serialNo'),
      (c_short, 'channel'),
      (c_short, 'source')]),
    ('PBC_RequestMaximumTravel', c_bool, 'log_errcheck',
     [(c_char_p, 'serialNo'),
      (c_short, 'channel')]),
    ...
    ('PBC_SetPosition', c_short, 'errcheck_api',
     [(c_char_p, 'serialNo'),
      (c_short, 'channel'),
      (c_short, 'position')]),
    ('PBC_RequestFeedbackLoopPIconsts', c_bool, 'log_errcheck',
     [(c_char_p, 'serialNo'),
      (c_short, 'channel')]),
...
Benchtop_PrecisionPiezo_FCNS = [
    ...
    ('PPC_GetMaxOutputVoltage', c_short, 'log_errcheck',
     [(c_char_p, 'serialNo')]),
    ('PPC_RequestMaxOutputVoltage', c_bool, 'log_errcheck',
     [(c_char_p, 'serialNo')]),
    ...
    ('PPC_GetOutputVoltage', c_short, 'log_errcheck',
     [(c_char_p, 'serialNo')]),
    ('PPC_RequestOutputVoltage', c_bool, 'log_errcheck',
     [(c_char_p, 'serialNo')]),
    ('PPC_SetOutputVoltage', c_short, 'errcheck_api',
     [(c_char_p, 'serialNo'),
      (c_short, 'volts')]),
    ('PPC_RequestVoltageSource', c_bool, 'log_errcheck',
     [(c_char_p, 'serialNo')]),
    ...
    ('PPC_SetNotchParams', c_short, 'errcheck_api',
     [(c_char_p, 'serialNo'),
      (POINTER(PPC_NotchParams), 'notchParams')]),
    ('PPC_RequestPIDConsts', c_bool, 'log_errcheck',
     [(c_char_p, 'serialNo')]),
    ...
    ('PPC2_GetMaxOutputVoltage', c_short, 'log_errcheck',
     [(c_char_p, 'serialNo'),
      (c_int, 'channel')]),
    ('PPC2_RequestMaxOutputVoltage', c_bool, 'log_errcheck',
     [(c_char_p, 'serialNo'),
      (c_int, 'channel')]),
    ...
    ('PPC2_GetOutputVoltage', c_short, 'log_errcheck',
     [(c_char_p, 'serialNo'),
      (c_int, 'channel')]),
    ('PPC2_RequestOutputVoltage', c_bool, 'log_errcheck',
     [(c_char_p, 'serialNo'),
      (c_int, 'channel')]),
    ('PPC2_SetOutputVoltage', c_short, 'errcheck_api',
     [(c_char_p, 'serialNo'),
      (c_int, 'channel'),
      (c_short, 'volts')]),
    ('PPC2_RequestVoltageSource', c_bool, 'log_errcheck',
     [(c_char_p, 'serialNo'),
      (c_int, 'channel')]),
    ...
    ('PPC2_SetNotchParams', c_short, 'errcheck_api',
     [(c_char_p, 'serialNo'),
      (c_int, 'channel'),
      (POINTER(PPC_NotchParams), 'notchParams')]),
    ('PPC2_RequestPIDConsts', c_bool, 'log_errcheck',
     [(c_char_p, 'serialNo'),
      (c_int, 'channel')]),
...
Benchtop_StepperMotor_FCNS = [
    ...
    ('SBC_MaxChannelCount', c_int, 'log_errcheck',
     [(c_char_p, 'serialNo')]),
    ('SBC_Identify', c_short, 'errcheck_api',
     [(c_char_p, 'serialNo')]),
...
IntegratedStepperMotors_FCNS = [
    ...
    ('ISC_MoveAtVelocity', c_short, 'errcheck_api',
     [(c_char_p, 'serialNo'),
      (c_short, 'direction')]),
    ('ISC_SetDirection', None, 'errcheck_api',
     [(c_char_p, 'serialNo'),
      (c_bool, 'reverse')]),
    ...
    ('ISC_GetMotorTravelLimits', c_short, 'errcheck_api',
     [(c_char_p, 'serialNo'),
      (POINTER(c_double), 'minPosition'),
      (POINTER(c_double), 'maxPosition')]),
    ('ISC_GetRealValueFromDeviceUnit', c_short, 'log_errcheck',
     [(c_char_p, 'serialNo'),
      (c_int, 'device_unit'),
      (POINTER(c_double), 'real_unit'),
      (c_int, 'unitType')]),
...
KCube_BrushlessMotor_FCNS = [
    ...
    ('BMC_GetMMIParamsExt', c_short, 'errcheck_api',
     [(c_char_p, 'serialNo'),
      ...
      (POINTER(c_int32), 'joystickMaxVelocity'),
      (POINTER(c_int32), 'joystickAcceleration'),
    ...
    ('BMC_SetMMIParamsExt', c_short, 'errcheck_api',
     [(c_char_p, 'serialNo'),
      ...
      (c_int32, 'joystickMaxVelocity'),
      (c_int32, 'joystickAcceleration'),
...
KCube_Piezo_FCNS = [
    ...
    ('PCC_SetPositionControlMode', c_short, 'errcheck_api',
     [(c_char_p, 'serialNo'),
      (c_short, 'mode')]),
    ('PCC_SetZero', c_bool, 'log_errcheck',
     [(c_char_p, 'serialNo')]),
    ('PCC_GetMaxOutputVoltage', c_short, 'log_errcheck',
     [(c_char_p, 'serialNo')]),
    ('PCC_RequestMaxOutputVoltage', c_bool, 'log_errcheck',
     [(c_char_p, 'serialNo')]),
    ...
    ('PCC_SetOutputVoltage', c_short, 'errcheck_api',
     [(c_char_p, 'serialNo'),
      (c_short, 'volts')]),
    ('PCC_RequestVoltageSource', c_bool, 'log_errcheck',
     [(c_char_p, 'serialNo')]),
    ...
    ('PCC_SetPosition', c_short, 'errcheck_api',
     [(c_char_p, 'serialNo'),
      (WORD, 'position')]),
    ('PCC_RequestFeedbackLoopPIconsts', c_bool, 'log_errcheck',
     [(c_char_p, 'serialNo')]),
    ...
    ('PCC_StopLUTwave', c_short, 'errcheck_api',
     [(c_char_p, 'serialNo')]),
    ('PCC_RequestLEDBrightness', c_bool, 'log_errcheck',
     [(c_char_p, 'serialNo')]),
    ...
    ('PCC_SetLEDBrightness', c_short, 'errcheck_api',
     [(c_char_p, 'serialNo'),
      (c_short, 'brightness')]),
    ('PCC_RequestIOSettings', c_bool, 'log_errcheck',
     [(c_char_p, 'serialNo')]),
    ...
    ('PCC_RequestMMIParams', c_bool, 'log_errcheck',
     [(c_char_p, 'serialNo')]),
    ...
    ('PCC_SetMMIParams', c_short, 'errcheck_api',
     [(c_char_p, 'serialNo'),
      ...
      (c_int32, 'presetVoltage2'),
      (c_int16, 'displayIntensity')]),
    ('PCC_RequestTriggerConfigParams', c_bool, 'log_errcheck',
     [(c_char_p, 'serialNo')]),
...
KCube_PositionAligner_FCNS = [
    ...
    ('QD_SetOperatingMode', c_short, 'errcheck_api',
     [(c_char_p, 'serialNo'),
      (c_short, 'mode')]),
    ('QD_RequestsLEDBrightness', c_short, 'errcheck_api',
     [(c_char_p, 'serialNo')]),
...
KCube_StepperMotor_FCNS = [
    ...
    ('SCC_MoveAtVelocity', c_short, 'errcheck_api',
     [(c_char_p, 'serialNo'),
      (c_short, 'direction')]),
    ('SCC_SetDirection', None, 'errcheck_api',
     [(c_char_p, 'serialNo'),
      (c_bool, 'reverse')]),
