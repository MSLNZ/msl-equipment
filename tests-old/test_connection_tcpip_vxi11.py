...
def rpc_server(address, prog_port):
    ...
    request = (
        b"\x80\x00\x008\x00\x00\x00\x01\x00\x00\x00\x00\x00\x00\x00\x02"
    ...
    reply = (
        b"\x80\x00\x00\x1c\x00\x00\x00\x01\x00\x00\x00\x01\x00\x00\x00\x00"
...
def rpc_program(address, prog_port):
    ...
    link_request_prefix = (
        b"\x80\x00\x00@\x00\x00\x00\x01\x00\x00\x00\x00\x00"
        b"\x00\x00\x02\x00\x06\x07\xaf\x00\x00\x00\x01\x00"
        b"\x00\x00\n\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
        b"\x00\x00\x00\x00\x00\x00"
    )
    link_request_suffix = b"\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x05inst0\x00\x00\x00"

    link_reply = (
        b"\x80\x00\x00(\x00\x00\x00\x01\x00\x00\x00\x01\x00\x00\x00"
        b"\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
        b"\x00\x00\x00\x00\x00\x00\x00\x00\x00\x02k\x00\x00\x05\xdc"
    )

    idn_request = (
        b"\x80\x00\x00D\x00\x00\x00\x02\x00\x00\x00\x00\x00\x00\x00\x02"
    ...
    idn_reply = (
        b"\x80\x00\x00 \x00\x00\x00\x02\x00\x00\x00\x01\x00\x00"
        b"\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
        b"\x00\x00\x00\x00\x00\x00\x00\x00\x05"
    )

    read_request = (
        b"\x80\x00\x00@\x00\x00\x00\x03\x00\x00\x00\x00\x00\x00\x00"
    ...
    read_reply = (
        b"\x80\x00\x00\\\x00\x00\x00\x03\x00\x00\x00\x01\x00\x00"
        b"\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
    ...
    unlink_request = (
        b"\x80\x00\x00,\x00\x00\x00\x04\x00\x00\x00\x00\x00\x00"
    ...
    unlink_reply = (
        b"\x80\x00\x00\x1c\x00\x00\x00\x04\x00\x00\x00\x01\x00"
        b"\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
        b"\x00\x00\x00\x00\x00\x00"
    )

    sleep_request = (
        b"\x80\x00\x00D\x00\x00\x00\x04\x00\x00\x00\x00\x00\x00"
        b"\x00\x02\x00\x06\x07\xaf\x00\x00\x00\x01\x00\x00\x00"
...
def test_protocol():
    ...
    assert (
        dev.byte_buffer == b"\x00\x00\x00\x03\x00\x00\x00\x00\x00\x00\x00\x02\x00"
...
def test_exceptions():
    ...
    record = EquipmentRecord(connection=ConnectionRecord(address="TCPIP::" + address, properties={"timeout": 1}))
