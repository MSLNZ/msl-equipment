...
@pytest.mark.skipif(sys.version_info.major == 2, reason="Python 2 cannot use np.fromiter with bytes")
...
"""
    ...
    assert info == {
        ...
        "Interfaces": [
            ...
            {"InterfaceType": "MyInterface", "InterfaceName": "MyName", "InstrumentAddressStrings": ["hostname:1234"]},
        ],
        "Domain": "1",
        "LXIVersion": "1.5",
    }
