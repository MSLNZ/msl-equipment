from ctypes import c_int8, c_int16, c_uint16, c_int32, c_uint32, c_float, c_void_p, c_int64, byref
...
class PicoScope2000A(PicoScope):
    ...
    def __init__(self, record):
        PicoScope.__init__(self, record, ps2000aApi_funcptrs)
        raise NotImplementedError('The {} class has not been tested'.format(self.__class__.__name__))

    def close_unit(self):
        self.sdk.ps2000aCloseUnit(self._handle)

    def enumerate_units(self):
        count = c_int16()
        serials = c_int8()
        serial_lth = c_int16()
        self.sdk.ps2000aEnumerateUnits(byref(count), byref(serials), byref(serial_lth))
        return count.value, serials.value, serial_lth.value

    def flash_led(self, start):
        self.sdk.ps2000aFlashLed(self._handle, start)

    def get_analogue_offset(self, range_, coupling):
        maximum_voltage = c_float()
        minimum_voltage = c_float()
        self.sdk.ps2000aGetAnalogueOffset(self._handle, range_, coupling, byref(maximum_voltage),
    ...
    def get_channel_information(self, info, probe, channels):
        ranges = c_int32()
        length = c_int32()
        self.sdk.ps2000aGetChannelInformation(self._handle, info, probe, byref(ranges),
                                              byref(length), channels)
    ...
    def get_max_down_sample_ratio(self, no_of_unaggreated_samples, down_sample_ratio_mode, segment_index):
        ...
        self.sdk.ps2000aGetMaxDownSampleRatio(self._handle, no_of_unaggreated_samples,
                                              byref(max_down_sample_ratio), down_sample_ratio_mode,
                                              segment_index)
        return max_down_sample_ratio.value

    def get_max_segments(self):
        max_segments = c_uint16()
        self.sdk.ps2000aGetMaxSegments(self._handle, byref(max_segments))
        return max_segments.value

    def get_no_of_captures(self):
        n_captures = c_uint32()
        self.sdk.ps2000aGetNoOfCaptures(self._handle, byref(n_captures))
        return n_captures.value

    def get_no_of_processed_captures(self):
        n_processed_captures = c_uint32()
        self.sdk.ps2000aGetNoOfProcessedCaptures(self._handle, byref(n_processed_captures))
        return n_processed_captures.value

    def get_streaming_latest_values(self, lp_ps):
        p_parameter = c_void_p()
        self.sdk.ps2000aGetStreamingLatestValues(self._handle, lp_ps, byref(p_parameter))
    ...
    def get_timebase(self, timebase, no_samples, oversample, segment_index):
        ...
        max_samples = c_int32()
        self.sdk.ps2000aGetTimebase(self._handle, timebase, no_samples, byref(time_interval_nanoseconds),
    ...
    def get_timebase2(self, timebase, no_samples, oversample, segment_index):
        ...
        max_samples = c_int32()
        self.sdk.ps2000aGetTimebase2(self._handle, timebase, no_samples, byref(time_interval_nanoseconds),
                                     oversample, byref(max_samples), segment_index)
        return time_interval_nanoseconds.value, max_samples.value
    ...
    def get_trigger_time_offset(self, segment_index):
        ...
        time_lower = c_uint32()
        time_units = c_enum()
        self.sdk.ps2000aGetTriggerTimeOffset(self._handle, byref(time_upper), byref(time_lower),
    ...
    def get_trigger_time_offset64(self, segment_index):
        time = c_int64()
        time_units = c_enum()
        self.sdk.ps2000aGetTriggerTimeOffset64(self._handle, byref(time), byref(time_units), segment_index)
        return time.value, time_units.value

    def get_unit_info(self, string_length, info):
        string = c_int8()
        required_size = c_int16()
        self.sdk.ps2000aGetUnitInfo(self._handle, byref(string), string_length, byref(required_size), info)
    ...
    def get_values(self, start_index, down_sample_ratio, down_sample_ratio_mode, segment_index):
        ...
        overflow = c_int16()
        self.sdk.ps2000aGetValues(self._handle, start_index, byref(no_of_samples), down_sample_ratio,
    ...
    def get_values_async(self, start_index, no_of_samples, down_sample_ratio, down_sample_ratio_mode, segment_index):
        ...
        p_parameter = c_void_p()
        self.sdk.ps2000aGetValuesAsync(self._handle, start_index, no_of_samples, down_sample_ratio,
    ...
    def get_values_bulk(self, from_segment_index, to_segment_index, down_sample_ratio, down_sample_ratio_mode):
        no_of_samples = c_uint32()
        overflow = c_int16()
        self.sdk.ps2000aGetValuesBulk(self._handle, byref(no_of_samples), from_segment_index, to_segment_index,
    ...
    def get_values_overlapped(self, start_index, down_sample_ratio, down_sample_ratio_mode, segment_index):
        no_of_samples = c_uint32()
        overflow = c_int16()
        self.sdk.ps2000aGetValuesOverlapped(self._handle, start_index, byref(no_of_samples), down_sample_ratio,
                                            down_sample_ratio_mode, segment_index, byref(overflow))
        return no_of_samples.value, overflow.value
    ...
    def get_values_overlapped_bulk(self, start_index, down_sample_ratio, down_sample_ratio_mode,
        ...
        no_of_samples = c_uint32()
        overflow = c_int16()
        self.sdk.ps2000aGetValuesOverlappedBulk(self._handle, start_index, byref(no_of_samples),
    ...
    def get_values_trigger_time_offset_bulk64(self, from_segment_index, to_segment_index):
        times = c_int64()
        time_units = c_enum()
        self.sdk.ps2000aGetValuesTriggerTimeOffsetBulk64(self._handle, byref(times), byref(time_units),
                                                         from_segment_index, to_segment_index)
        return times.value, time_units.value

    def hold_off(self, holdoff, typ):
        self.sdk.ps2000aHoldOff(self._handle, holdoff, typ)

    def is_ready(self):
        ready = c_int16()
        self.sdk.ps2000aIsReady(self._handle, byref(ready))
        return ready.value

    def is_trigger_or_pulse_width_qualifier_enabled(self):
        trigger_enabled = c_int16()
        pulse_width_qualifier_enabled = c_int16()
        self.sdk.ps2000aIsTriggerOrPulseWidthQualifierEnabled(self._handle, byref(trigger_enabled),
                                                              byref(pulse_width_qualifier_enabled))
        return trigger_enabled.value, pulse_width_qualifier_enabled.value

    def maximum_value(self):
        value = c_int16()
        self.sdk.ps2000aMaximumValue(self._handle, byref(value))
        return value.value

    def memory_segments(self, n_segments):
        n_max_samples = c_int32()
        self.sdk.ps2000aMemorySegments(self._handle, n_segments, byref(n_max_samples))
        return n_max_samples.value

    def minimum_value(self):
        value = c_int16()
        self.sdk.ps2000aMinimumValue(self._handle, byref(value))
        return value.value

    def no_of_streaming_values(self):
        no_of_values = c_uint32()
        self.sdk.ps2000aNoOfStreamingValues(self._handle, byref(no_of_values))
        return no_of_values.value

    def open_unit(self):
        handle = c_int16()
        serial = c_int8()
        self.sdk.ps2000aOpenUnit(byref(handle), byref(serial))
        if handle.value > 0:
            self._handle = handle
        return serial.value
    ...
    def open_unit_async(self):
        status = c_int16()
        serial = c_int8()
        self.sdk.ps2000aOpenUnitAsync(byref(status), byref(serial))
    ...
    def open_unit_progress(self):
        ...
        complete = c_int16()
        self.sdk.ps2000aOpenUnitProgress(byref(handle), byref(progress_percent), byref(complete))
        if handle.value > 0:
            self._handle = handle
        return 100 if complete.value else progress_percent.value

    def ping_unit(self):
        self.sdk.ps2000aPingUnit(self._handle)
    ...
    def run_block(self, no_of_pre_trigger_samples, no_of_post_trigger_samples, timebase, oversample,
        ...
        p_parameter = c_void_p()
        self.sdk.ps2000aRunBlock(self._handle, no_of_pre_trigger_samples, no_of_post_trigger_samples,
    ...
    def run_streaming(self, sample_interval_time_units, max_pre_trigger_samples, max_post_pre_trigger_samples,
        ...
        self.sdk.ps2000aRunStreaming(self._handle, byref(sample_interval), sample_interval_time_units,
    ...
    def set_channel(self, channel, enabled, type_, range_, analog_offset):
        self.sdk.ps2000aSetChannel(self._handle, channel, enabled, type_, range_, analog_offset)

    def set_data_buffer(self, channel_or_port, buffer_lth, segment_index, mode):
        buffer = c_int16()
        self.sdk.ps2000aSetDataBuffer(self._handle, channel_or_port, byref(buffer), buffer_lth, segment_index, mode)
        return buffer.value

    def set_data_buffers(self, channel_or_port, buffer_lth, segment_index, mode):
        buffer_max = c_int16()
        buffer_min = c_int16()
        self.sdk.ps2000aSetDataBuffers(self._handle, channel_or_port, byref(buffer_max), byref(buffer_min),
                                       buffer_lth, segment_index, mode)
        return buffer_max.value, buffer_min.value

    def set_digital_analog_trigger_operand(self, operand):
        self.sdk.ps2000aSetDigitalAnalogTriggerOperand(self._handle, operand)

    def set_digital_port(self, port, enabled, logic_level):
        self.sdk.ps2000aSetDigitalPort(self._handle, port, enabled, logic_level)

    def set_ets(self, mode, ets_cycles, ets_interleave):
        sample_time_picoseconds = c_int32()
        self.sdk.ps2000aSetEts(self._handle, mode, ets_cycles, ets_interleave, byref(sample_time_picoseconds))
        return sample_time_picoseconds.value

    def set_ets_time_buffer(self, buffer_lth):
        buffer = c_int64()
        self.sdk.ps2000aSetEtsTimeBuffer(self._handle, byref(buffer), buffer_lth)
        return buffer.value

    def set_ets_time_buffers(self, buffer_lth):
        time_upper = c_uint32()
        time_lower = c_uint32()
        self.sdk.ps2000aSetEtsTimeBuffers(self._handle, byref(time_upper), byref(time_lower), buffer_lth)
        return time_upper.value, time_lower.value

    def set_no_of_captures(self, n_captures):
        self.sdk.ps2000aSetNoOfCaptures(self._handle, n_captures)

    def set_pulse_width_qualifier(self, n_conditions, direction, lower, upper, type_):
        conditions = PS2000APwqConditions()
        self.sdk.ps2000aSetPulseWidthQualifier(self._handle, byref(conditions), n_conditions, direction,
                                               lower, upper, type_)
    ...
    def set_sig_gen_arbitrary(self, offset_voltage, pk_to_pk, start_delta_phase, stop_delta_phase,
        ...
        self.sdk.ps2000aSetSigGenArbitrary(self._handle, offset_voltage, pk_to_pk, start_delta_phase,
                                           stop_delta_phase, delta_phase_increment, dwell_count,
                                           byref(arbitrary_waveform), arbitrary_waveform_size, sweep_type,
                                           operation, index_mode, shots, sweeps, trigger_type,
    ...
    def set_sig_gen_built_in(self, offset_voltage, pk_to_pk, wave_type, start_frequency, stop_frequency,
                             ...
                             trigger_source, ext_in_threshold):
        self.sdk.ps2000aSetSigGenBuiltIn(self._handle, offset_voltage, pk_to_pk, wave_type, start_frequency,
    ...
    def set_sig_gen_built_in_v2(self, offset_voltage, pk_to_pk, wave_type, start_frequency, stop_frequency,
                                increment, dwell_time, sweep_type, operation, shots, sweeps, trigger_type,
                                trigger_source, ext_in_threshold):
        self.sdk.ps2000aSetSigGenBuiltInV2(self._handle, offset_voltage, pk_to_pk, wave_type, start_frequency,
                                           stop_frequency, increment, dwell_time, sweep_type, operation, shots,
                                           sweeps, trigger_type, trigger_source, ext_in_threshold)
    ...
    def set_sig_gen_properties_arbitrary(self, start_delta_phase, stop_delta_phase, delta_phase_increment,
                                         ...
                                         ext_in_threshold):
        self.sdk.ps2000aSetSigGenPropertiesArbitrary(self._handle, start_delta_phase, stop_delta_phase,
    ...
    def set_sig_gen_properties_built_in(self, start_frequency, stop_frequency, increment, dwell_time,
        ...
        self.sdk.ps2000aSetSigGenPropertiesBuiltIn(self._handle, start_frequency, stop_frequency, increment,
    ...
    def set_simple_trigger(self, enable, source, threshold, direction, delay, auto_trigger_ms):
        self.sdk.ps2000aSetSimpleTrigger(self._handle, enable, source, threshold, direction, delay, auto_trigger_ms)
    ...
    def set_trigger_channel_directions(self, channel_a, channel_b, channel_c, channel_d, ext, aux):
        self.sdk.ps2000aSetTriggerChannelDirections(self._handle, channel_a, channel_b, channel_c, channel_d, ext, aux)
    ...
    def set_trigger_delay(self, delay):
        self.sdk.ps2000aSetTriggerDelay(self._handle, delay)
    ...
    def sig_gen_arbitrary_min_max_values(self):
        ...
        self.sdk.ps2000aSigGenArbitraryMinMaxValues(self._handle, byref(min_arbitrary_waveform_value),
    ...
    def sig_gen_frequency_to_phase(self, frequency, index_mode, buffer_length):
        phase = c_uint32()
        self.sdk.ps2000aSigGenFrequencyToPhase(self._handle, frequency, index_mode, buffer_length, byref(phase))
        return phase.value

    def sig_gen_software_control(self, state):
        self.sdk.ps2000aSigGenSoftwareControl(self._handle, state)

    def stop(self):
        self.sdk.ps2000aStop(self._handle)
